...
G.FUNCS.uv_test_button_action = function(e)
    ease_dollars(1)
    play_sound('coin1')
end
G.FUNCS.uv_close_test_window = function(e)
...
SMODS.Consumable {key = "test_deck_card",
    set = "DeckCard",
    ...
    use = function(self, card, area, copier)
        ...
        local test_window_ui = {
            n = G.UIT.ROOT,
            config = { align = "cm", colour = G.C.BLACK, r = 0.1, padding = 0.3 },
            nodes = {
                {
                    n = G.UIT.R,
                    config = { align = "cm", padding = 0.1 },
                    nodes = {
                        { n = G.UIT.T, config = { text = "TEST WINDOW", scale = 0.5, colour = G.C.WHITE } }
                    }
                },
                {
                    n = G.UIT.R,
                    ...
                    nodes = {
                        {
                            ...
                            config = {
                                ...
                                r = 0.1,
                                hover = true,
                                button = 'uv_test_button_action',
                                padding = 0.2,
                                minw = 2,
                                minh = 0.8
                            },
                            nodes = {
                                { n = G.UIT.T, config = { text = "Get $1", scale = 0.4, colour = G.C.WHITE } }
                            }
                        }
                    }
                },
                    ...
                    nodes = {
                        {
                            ...
                            config = {
                                ...
                                r = 0.1,
                                hover = true,
                                button = 'uv_close_test_window',
                                padding = 0.1
                            },
                            nodes = {
                                { n = G.UIT.T, config = { text = "Close", scale = 0.3, colour = G.C.WHITE } }
                            }
                        }
                    }
                }
        ...
        G.OVERLAY_MENU = UIBox{
            definition = test_window_ui,
            config = { offset = { x = 0, y = 0 }, type = 'cm', bond = 'cm' }
        }
    end
}